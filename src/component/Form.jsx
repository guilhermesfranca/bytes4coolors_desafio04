...
export default function Example() {
  return (
    <form
      className="flex flex-col items-center text-sm text-purple-800"
      action="https://formspree.io/f/xjkagzey"
      method="POST"
    >
      <p className="text-xs bg-indigo-200 mt-20 text-purple-500 font-medium px-3 py-1 rounded-full">
        Entre em Contato
      </p>
      ...
      <p className="max-md:text-sm text-gray-500 pb-10 text-center">
        ...
        <a
          href="mailto:guilhermesfranca@outlook.com"
          className="text-purple-600 hover:underline"
        >
          guilhermesfranca@outlook.com
        </a>
      </p>
      ...
      <div className="max-w-96 w-full px-4">
        ...
        <button
          type="submit"
          className="flex items-center justify-center gap-1 mt-5 bg-purple-500 hover:bg-purple-600 text-white py-2.5 w-full rounded-full transition"
        >
          Submit Form
          <svg
            className="mt-0.5"
